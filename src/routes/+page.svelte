  ...
  const grids = [
    {
      ...
      headline: 'Float grid with padding gutters',
    ...
    },
    {
      id: 'float-margin',
      label: 'Margin floats',
      headline: 'Float grid with margin gutters',
    ...
    },
    {
      ...
      headline: 'Float grid with isolated columns',
      component: FloatsIsolated,
      cssKey: 'floatsIsolatedCSS',
    },
    {
      id: 'inline-block-plain',
      label: 'Plain inline-block',
      headline: 'Inline-block grid with margin gutters',
      component: InlineBlock,
      cssKey: 'inlineBlockCSS',
    },
    {
      id: 'inline-block-justified',
      label: 'Justified inline-block',
      headline: 'Inline-block grid with text-align-justify',
      component: InlineBlockJustified,
      cssKey: 'inlineBlockJustifiedCSS',
    },
    {
      id: 'inline-block-last-line',
      label: 'Last-line inline-block',
      headline: 'Inline-block grid with text-align-last',
    ...
    },
    {
      ...
      headline: 'Table grid with border-spacing gutters',
